...
var target = nestedNumberArray[2][1][2]
// assign `target` the value of 42 using the `nestedNumberArray` variable
// 

// WHAT??? - I don't understand the answer on solved.....
...
for (var i = 0; i<iterateArrObjects.length; i++)
...
function iterateArrObjectsReverse(arrOfObj){
  // ---------- Your Code Here ----------
for (var i = iterateArrObjects.length - 1; i > -1; i--)
console.log(toyArrayOfObjects[i].product);
console.log(toyArrayOfObjects[i].item);
console.log("*************************");
